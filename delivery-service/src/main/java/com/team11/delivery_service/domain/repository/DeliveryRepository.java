...
public interface DeliveryRepository extends JpaRepository<Delivery, UUID> {
    ...
    Optional<List<Delivery>> findAllByHubIdAndDeletedIsFalse(UUID hubId);

    Optional<List<Delivery>> findAllByDeliveryAddressAndDeletedIsFalse(String deliveryAddress);
}
